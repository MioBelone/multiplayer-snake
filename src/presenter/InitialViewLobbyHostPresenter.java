 ...
 * @author Fabian Haese
 */
public class InitialViewLobbyHostPresenter {
    ...
    public InitialViewLobbyHostPresenter(Stage primaryStage, InitialModel initialModel) {
    ...
    public InitialViewLobbyHostPresenter() {
    }
